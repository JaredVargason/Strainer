...
// StrainerProcessor
//------------------------------------------------------------------------
StrainerProcessor::StrainerProcessor ()
{
	//--- set the wanted controller for our processor
	setControllerClass (kStrainerControllerUID);
}
...
//------------------------------------------------------------------------
tresult PLUGIN_API StrainerProcessor::initialize (FUnknown* context)
{
...
//------------------------------------------------------------------------
tresult PLUGIN_API StrainerProcessor::terminate ()
{
...
//------------------------------------------------------------------------
tresult PLUGIN_API StrainerProcessor::setActive (TBool state)
{
...
//------------------------------------------------------------------------
tresult PLUGIN_API StrainerProcessor::process (Vst::ProcessData& data)
{
...
//------------------------------------------------------------------------
tresult PLUGIN_API StrainerProcessor::setupProcessing (Vst::ProcessSetup& newSetup)
{
...
//------------------------------------------------------------------------
tresult PLUGIN_API StrainerProcessor::canProcessSampleSize (int32 symbolicSampleSize)
{
...
//------------------------------------------------------------------------
tresult PLUGIN_API StrainerProcessor::setState (IBStream* state)
{
...
//------------------------------------------------------------------------
tresult PLUGIN_API StrainerProcessor::getState (IBStream* state)
{
